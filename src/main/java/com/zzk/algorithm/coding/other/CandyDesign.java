...
/**
 * @ClassName CandyDesign
 * @Description 22.分糖果问题
 * @Author zzk
 * @Date 2021/3/17 22:16
 **/
public class CandyDesign {
    ...
    private int rightCands(int[] arr, int left, int right) {
        int n = right - left + 1;
        return n + n * (n - 1) / 2;
    }
    ...
    private int[] rightCandsAndBase(int[] arr, int left, int right) {
        int base = 1;
        int cands = 1;
